...
function Signup() {
  ...
  //   setMyMap(myMap.set(key, value)); // this won't trigger any rerender, because react compares references from"old" map with "new" map, and both have the same.
  //   // setMyMap(new Map(myMap.set(key, value)));//this will trigger component rerender, because generates a new map each time. Chose the option that works better
